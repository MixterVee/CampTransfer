...
echo Preparing Turtle Transfer artwork...
powershell -NoProfile -ExecutionPolicy Bypass -File build\GenerateTurtleIcon.ps1 -OutputPath assets\TurtleTransfer.ico
if errorlevel 1 (
    echo.
